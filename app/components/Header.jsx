    ...
    <div>
      <nav className="bg-gray-700 py-4 px-6 flex items-center justify-between mb-0 shadow-md shadow-slate-500">
        <div className="flex items-center">
          ...
          <Link href="/">
            <div className="hidden text-sm sm:flex items-center uppercase text-white hover:text-slate-200">
              AI.Hendersen
            </div>
          </Link>
          <Link href="/">
            <div className="flex items-center uppercase text-slate-400 hover:text-white mx-10">
              <svg
